...
{
public:	
	COMMAND_LIST(int client_id, int socket_fd, CLIENT_LIST *client_list);
	~COMMAND_LIST();
//*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
...
//*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
	PARSE_RESULT parse_argv(PIPE_TYPE& pipe_type, int& exec_argc, int& remove_argc, int& pipe_destination, bool& handle_to_client, int& pipe_to_client, bool& handle_from_client, int& pipe_from_client, bool& handle_new_line, bool& handle_output_file, bool& handle_error);
//*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
	void remove_current_command(int command_size);
//*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*
	void exec_printenv();
	void exec_setenv();
	EXEC_RESULT exec_command(PIPE_TYPE pipe_type, int pipe_destination, bool handle_to_client, int pipe_to_client, bool handle_from_client, int pipe_from_client, bool handle_new_line, bool handle_output_file, bool handle_error, int output_file_fd, char **argv, bool& exec_error);
