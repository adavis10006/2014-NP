...
//*---------------------------------------------*   
	int FIFO_read_fd;
//*---------------------------------------------*   
	if((FIFO_read_fd = open(client_list[outset_id - 1].message[destination_id - 1].FIFO_name, O_RDONLY | O_NONBLOCK)) < 0)
...
//*---------------------------------------------*
	client_list[outset_id - 1].message[destination_id - 1].FIFO_read_fd = FIFO_read_fd;
	client_list[outset_id - 1].message[destination_id - 1].message_state = MESSAGE_USED;
//*---------------------------------------------*
	if((destination_fd = open(client_list[outset_id - 1].message[destination_id - 1].FIFO_name, O_WRONLY | O_NONBLOCK)) < 0)
	{	
